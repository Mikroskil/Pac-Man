...
<form id="form-login" name="login" method="post" action="cek_login.php" onSubmit="return validasi(this)">
  ...
  * Pegawai yang belum mempunyai user untuk login silahkan registrasi disini <a style="color:#ffcf43" href='registrasi.php'>Registrasi Pegawai</a> <a style="color:#ffcf43" href='adm.php'>Registrasi Admin disini</a>, selanjutnya silahkan login menggunakan NIP dan password *
</div>
