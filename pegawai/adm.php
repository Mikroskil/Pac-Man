...
label:before {
  ...
  <body style=background:url(images/back.gif);>
  <body>
...
<tr><td colspan="2"><h3>Template WebPage</h3></td></tr>
<tr><td>Tema Page</td><td><select name="pg" id="pg" onChange="if(options[selectedIndex].value) window.open(options[selectedIndex].value,'_blank','config');" size="1">   
<option>Pilih tema</option>   
<option value="../../sites/theme1.php">tema1</option>   
<option value="../../sites/theme2.php">tema2</option>   
</select></td></tr>
