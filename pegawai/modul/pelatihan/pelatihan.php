...
switch($_GET[act]){
	...
	$tampil=mysql_query("select * from pegawai,pelatihan where pegawai.nip=pelatihan.nip and pegawai.NomorId='$ff' order by id_pelatihan");
...
echo "  
  ...
  return $url;
	...
	$urcl=substr(geturl(),80);
	$ambil=mysql_query("select * from pegawai,pelatihan where pelatihan.nip=pegawai.nip and pegawai.NomorId='$ff' and pelatihan.id_pelatihan='$urcl'");
