...
switch($_GET[act]){
	default:
	$tanggal= date('Y-m-d');
	$tampil=mysql_query("select * from pegawai,bagian,jabatan where pegawai.id_jab=jabatan.id_jab and pegawai.id_bag=bagian.id_bag and pegawai.NomorId='$ff'");
...
echo "  
	...
	case "ubah":
	$tanggal2= date('Y-m-d');
	$tampil2=mysql_query("select * from pegawai,bagian,jabatan where pegawai.id_jab=jabatan.id_jab and pegawai.id_bag=bagian.id_bag and pegawai.NomorId='$ff'");
	echo "<div><h2 class='head'>DATA KENAIKAN JABATAN</h2></div>
	<table class='tabel'>
	<thead>
  <tr>
...
echo "  
	...
	";
	$tanggal= date('Y-m-d');
	$tampil=mysql_query("select * from pegawai,bagian,jabatan where pegawai.id_jab=jabatan.id_jab and pegawai.id_bag=bagian.id_bag and pegawai.NomorId='$ff'and nip='$_GET[id]'");
	...
	$jab=mysql_query("select * from jabatan where jabatan.NomorId='$ff'");
