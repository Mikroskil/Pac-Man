...
$module=$_GET['module'];
$act=$_GET['act'];
$np=isset($_POST["namp"])?$_POST["namp"]:"";
$gt=mysql_query("SELECT NomorId FROM user WHERE NamaPerusahaan='$np'");
...
if($module=='pegawai' AND $act=='input' ){
  ...
  $nama_file_unik = $acak.$nama_file;
	...
	mysql_query("insert into pegawai set nip='$_POST[nip]',
										 ...
										 foto='$nama_file_unik'
										 ");
	mysql_query("insert into user set userid='$_POST[nip]', passid='$_POST[psl]', level_user='3',NomorId='$ff'");
