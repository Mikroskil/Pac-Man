...
$tampil=mysql_query("select * from user,pegawai,jabatan where pegawai.nip=user.userid and pegawai.id_jab=jabatan.id_jab and pegawai.NomorId='$ff' and user.level_user=3");
	echo "<h2 class='head'>$ff LAPORAN DATA PEGAWAI</h2>
	<table class='tabel'>
	<thead>
  <tr>
	<td>No</td>
