...
else if ($action == 'forget' || $action == 'forget_2')
{
	...
	if (isset($_POST['form_sent']))
	{
		...
		if (empty($errors))
		{
			...
			if (!empty($users_with_email))
			{
				...
				$mail_message = str_replace('<board_mailer>', sprintf($lang_common['Forum mailer']), $mail_message);
	...
	$forum_page['crumbs'] = array(
		array('login', forum_link($forum_url['login'])),
...
$forum_page['crumbs'] = array(
	...
	sprintf($lang_login['Login info'], 'Forum')
);
...
?>
	<div class="main-head">
		<h2 class="hn"><span><?php echo sprintf($lang_login['Login']) ?></span></h2>
	</div>
	<div class="main-content main-frm">
