...
?>
	<div class="main-head">
		<h2 class="hn"><span><?php echo sprintf($lang_profile['Register at'], 'acmp forum') ?></span></h2>
	</div>
...
?>
	<div class="main-head">
		<h2 class="hn"><span><?php echo sprintf($lang_profile['Register']) ?></span></h2>
	</div>
	<div class="main-content main-frm">
<?php
